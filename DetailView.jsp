<!DOCTYPE HTML><%@page import="com.call_log.model.CallerParticulars"%>
				...
				<div style="height: 100%; overflow-y: auto;">
					<div style="margin: 10px;">
						...
						<table class="CallerDetail"
							...
							<tr>
								<td style="padding-left: 50px; padding-top: 20px;"><label
									...
									name="nmName" id="idName" value="${callLogById.name}" disabled
								...
								<td style="padding-left: 50px;"><label
									...
									value="${callLogById.homePhoneNumber}" style="width: 100px;"></td>
							</tr>
							<tr>
								<td style="padding-left: 50px; padding-top: 20px;"><label
									style="padding-right: 20px;">Address</label> <label
									style="padding-right: 5px;">Blk</label><input type="text"
									name="nmBlock" id="idBlk" value="${callLogById.block}"
									style="width: 50px;" disabled> <input type="text"
									id="idAddress" value="${callLogById.address}" name="nmAddress"
									style="width: 160px;" disabled> <br /> <label
									style="padding-left: 80px; padding-right: 5px;">#</label><input
									type="text" id="idFloor" value="${callLogById.doorNumber}"
									name="nmFloor" style="width: 50px;" disabled> - <input
									type="text" id="idUnit" name="nmUnit"
									value="${callLogById.unitNumber}" style="width: 50px;" disabled>
									S( <input type="text" id="idPostalCode" name="nmPostalCode"
									value="${callLogById.postalcode}" style="width: 90px;" disabled>
									)</td>
								<td style="padding-left: 50px;"><label
									style="padding-right: 10px;">Office</label> <input type="text"
									id="idOffice" name="nmOffice"
									value="${callLogById.officePhoneNumber}" style="width: 100px;"
									disabled></td>
							</tr>
							<tr>
								<td style="padding-left: 50px;"><label
									style="padding-right: 50px;">IC Type</label> <input
									name="ICType" id="idICType" value="${callLogById.icType}"
									disabled style="width: 60px;"> <b>No</b> <input
									type="text" id="idICNo" name="nmICNo"
									value="${callLogById.icNumber}" style="width: 130px;" disabled></td>
								<td style="padding-left: 50px;"><label
									style="padding-right: 30px;">HP</label> <input type="text"
									id="idHP" name="nmHP" value="${callLogById.handPhoneNumber}"
						...
						<div
							...
							<div>
								<b><a onclick="OpenRatting('Caller')">${callLogById.rating}
										<input value="${callLogById.ratingType }"
							...
							<textarea id="txtDOE" name="nmtxtDOE"
								style="width: 500px; height: 100px;" disabled>${callLogById.detailsOfEncounter}</textarea>
						...
						<div class="form-group">
							<div style="float: left;">
								<input name="NE" id="idNatureofEnquiry" disabled
									value="${callLogById.natureOfEnquiry}"
							...
							<div style="float: right;">
								<input value="${callLogById.nameOfEnquiry }" name="NET"
									id="idNET" disabled
									style="width: 200px; background: transparent; border: 0px"
									disabled>
						...
						<input value="${callLogById.typeOfEnquiry}"
							style="background: transparent; border: 0px" disabled>
						<div class="form-group">
							...
							<textarea id="idCustomerComment" name="nmCustomerComment"
								style="width: 300px;" disabled>${callLogById.enquiryComments}</textarea>
						</div>
						<div class="ColorLabel">Follow-up OIC</div>
						<div>
							<input value="${callLogById.oic}"
								style="background: transparent; border: 0px" disabled>
						</div>
					</div>
				</div>
